...
class photoFragment extends Fragment {
    ...
    private void goToMain() {
        ...
        fragmentManager.beginTransaction().remove(com.example.car.photoFragment.this).commit();
...
//        bottomNavigationView.setOnNavigationItemSelectedListener(new MainActivity.TabSelectedListener());
//    }
//
