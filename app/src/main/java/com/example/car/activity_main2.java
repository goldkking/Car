    ...
    class TabSelectedListener implements BottomNavigationView.OnNavigationItemSelectedListener {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                case R.id.tab_home: {
                    getSupportFragmentManager().beginTransaction().replace(R.id.home_ly, new home()).commit();
                    return true;
                }
                case R.id.tab_mycar: {
                ...
                case R.id.tab_dashboard: {
                    getSupportFragmentManager().beginTransaction().replace(R.id.home_ly, new dashboard()).commit();
                    return true;
                }
